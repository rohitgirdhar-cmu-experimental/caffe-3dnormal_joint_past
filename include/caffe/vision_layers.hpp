...
template <typename Dtype>
class DecodeLayer : public Layer<Dtype> {
 public:
  explicit DecodeLayer(const LayerParameter& param)
      : Layer<Dtype>(param) {}
  virtual void SetUp(const vector<Blob<Dtype>*>& bottom,
      vector<Blob<Dtype>*>* top);
...
template <typename Dtype>
class AngleWithLossLayer : public Layer<Dtype> {
 public:
  explicit AngleWithLossLayer(const LayerParameter& param)
      : Layer<Dtype>(param) {}
  virtual void SetUp(const vector<Blob<Dtype>*>& bottom,
      vector<Blob<Dtype>*>* top);
