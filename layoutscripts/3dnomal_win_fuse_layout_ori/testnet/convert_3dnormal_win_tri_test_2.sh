...
GLOG_logtostderr=1 $rootfolder/build_balaton/examples/3dnormal/convert_normal_win_high_van_test.bin $sourcefolder/images/ $sourcefolder/locs/testLoc2.txt  $sourcefolder/leveldb_fusetest/3d_test_layout_ori_db2 0 0 55 55 $sourcefolder/reg_coarse_tri $sourcefolder/reg_localedge_tri/  $sourcefolder/reg_layout_coarse/
