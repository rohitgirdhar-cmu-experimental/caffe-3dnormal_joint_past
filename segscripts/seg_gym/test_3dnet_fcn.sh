...
GLOG_logtostderr=1  /nfs/hn46/xiaolonw/cnncode/caffe-3dnormal_r_n/build/tools/test_net_3dnormal_seg.bin  /nfs/hn46/xiaolonw/cnncode/caffe-3dnormal_r_n/segscripts/seg/seg_test_2fc_3dnormal.prototxt  /nfs/ladoga_no_backups/users/xiaolonw/oedata/models/seg/seg__iter_200000  /nfs/ladoga_no_backups/users/xiaolonw/oedata/testlist.txt   /nfs/ladoga_no_backups/users/xiaolonw/oedata/testresults_fcn/
