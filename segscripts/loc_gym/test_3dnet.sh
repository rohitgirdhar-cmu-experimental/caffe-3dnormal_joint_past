...
GLOG_logtostderr=1  /nfs/hn46/xiaolonw/cnncode/caffe-3dnormal_r_n/build/tools/test_net_3dnormal_loc.bin /nfs/hn46/xiaolonw/cnncode/caffe-3dnormal_r_n/segscripts/loc_gym/imagenet_test.prototxt    /nfs/ladoga_no_backups/users/xiaolonw/oedata/models/loc/loc__iter_200000   /nfs/ladoga_no_backups/users/xiaolonw/oedata/gymtest.txt  /nfs/ladoga_no_backups/users/xiaolonw/oedata/testresults_gym/  
