...
Layer<Dtype>* GetLayer(const LayerParameter& param) {
  ...
  case LayerParameter_LayerType_NORM:
    return new NormLayer<Dtype>(param);
  case LayerParameter_LayerType_ANGLE_LOSS:
      return new AngleWithLossLayer<Dtype>(param);
  ...
  case LayerParameter_LayerType_DECODE:
      return new DecodeLayer<Dtype>(param);
  case LayerParameter_LayerType_COMBINE:
